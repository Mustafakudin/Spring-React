...
const Input =(props)=>{ // props aldıgı değerleri asagıda kullanabiliriz
    const{label,errors,name, onChange ,type }=props; // object districton kullanabiliriz daha rahat olsun diye type sonradan ekledik cunku eklemezsek password kısmında sifre acık sekilde yazımı cıkıyor ondan doolayı buraya ekledik 
